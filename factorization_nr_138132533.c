/*
Lepore factorization nr. 138132533  simple  is free software
Lepore factorization nr. 138132533 simple is Alberico Lepore creation
this file is free software
The Lepore factorization nr. 138132533 simple is free software; you can redistribute it and/or modify
...
int main(){
 ...
 mpz_t N,p,q,mom1,mom2,M,X,a,zero,uno,due,exp,b,M2,y,z,r,A,B,resto,copia_di_exp,TEST;
...
mpz_div(exp,exp,due);
 ...
 while(mpz_cmp(p,uno)==0  || mpz_cmp(p,M)==0 ){
